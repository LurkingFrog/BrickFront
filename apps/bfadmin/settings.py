...
STATIC_ROOT = '/home/dfogelson/projects/BrickFront/static'
...
SECRET_KEY = 'gc(5+(uf1zpea51o1gr6&amp;1u&amp;1d7eo*s8+8&amp;^)&amp;yx97zr59!qre'
...
ROOT_URLCONF = 'bfadmin.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bfadmin.wsgi.application'
...
# For now, let's keep this explicit. Wildcards may come later
LOGIN_EXEMPT_URLS = ('/api/calendar/', )
